import BaseConfig from "@-/shared.node.unocss";
import { colors } from "@-/shared.node.unocss/helpers/colors";
...
export default BaseConfig(conf)
    ...
    .Theme()
    .Transformers()
    // doesn't work in production for now, 
    // somehow theme is translated in development but not in production
